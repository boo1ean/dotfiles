...
call <SID>X("Normal",		"dddddd",	"131313",	"none")
call <SID>X("Cursor",		"222222",	"ecee90",	"none")
call <SID>X("ColorColumn", "", "663333","none")
call <SID>X("Search",		"444444",	"af87d7",	"")
call <SID>X("MatchParen",	"ecee90",	"857b6f",	"bold")
call <SID>X("SpecialKey",	"212121",	"",	"none")
call <SID>X("Visual",		"",	"222222",	"none")
call <SID>X("LineNr",		"9ed543",	"",	"none")
...
call <SID>X("StatusLineNC",	"e5e2d7",	"444444",	"none")
			"Scrollbar
			"Tooltip
			"Menu
			"WildMenu
call <SID>X("Pmenu",		"DDDDDD",	"404048",	"")
call <SID>X("PmenuSel",		"DDDDDD",	"222222",	"")
call <SID>X("WarningMsg",	"ff7777",	"",			"")
			"ErrorMsg
			"ModeMsg
			"MoreMsg
			"Directory
...
" syntax highlighting
call <SID>X("Number",		"990000",	"",			"none")
call <SID>X("Constant",		"e5786d",	"",			"none")
call <SID>X("String",		"bb0000",	"",			"italic")
call <SID>X("Comment",		"4466ff",	"",			"italic")
call <SID>X("Identifier",	"898942",	"",			"none")
call <SID>X("Keyword",		"ff0000",	"",			"none") "keyword
call <SID>X("Statement",	"75a343",	"",			"bold")
call <SID>X("Function",		"a4659c",	"",			"none")
call <SID>X("PreProc",		"209897",	"",			"none")
call <SID>X("Type",			"00aa00",	"",			"none")
call <SID>X("Special",		"a92298",	"",			"none")
call <SID>X("Todo",			"0000ff",	"",			"italic")
